...
<html>
	...
	<body>
		<a href="#create-passenger" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-passenger" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:passengerInstance, action:'save']" >
				<fieldset class="form">
