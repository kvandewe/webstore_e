...
class gsp_test1_layoutsplasma2_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/plasma2.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',1343,[:],1)
printHtmlPart(9)
}
...
public static final long LAST_MODIFIED = 1406645380162L
